...
//       
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String name=nameTextField.getText();//get text se textfield m se value ko nikate h ot settext se set krte h
        ...
        try{
            if(name.equals("")||fname.equals("")){
                ...
                Conn c=new Conn();
                String querry="Insert into signup values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+state+"','"+pin+"')";
